return {
  {
    ...
    opts = function()
      ...
      -- Some logos can be found at: https://github.com/goolord/alpha-nvim/discussions/16
      local logo = [[
        ⠀⠀⣀⣀⡀⠀⠀⣀⣀⣀⣀⣀⣀⠀⠀⠀⣀⣀⣀⠀⠀⠀⠀⠀⣀⣀⠀⠀⠀⠀⣀⣀⡀⠀⢀⣀⡀⠀⢀⣀⣀⣀⣀⣀⡀⠀⠀
        ⣴⣿⠟⠛⢿⣦⡀⣿⡟⠛⠛⠛⣿⣷⣰⣿⠟⠛⢿⣷⡄⢠⣠⣤⣿⠻⠗⠀⣴⣿⠟⠛⢿⣦⣸⣿⣧⣾⡿⢛⣿⡿⠟⠻⣿⣦⠀
        ⣿⡇⠀⠀⠀⣿⡇⣿⣷⣄⡀⠀⠉⠁⣿⣇⠀⠀⠀⣿⡇⣀⡉⠻⢿⣶⣄⡰⣿⣇⠀⠀⠀⣿⡿⣿⣿⣅⡀⢸⣿⡀⠀⠀⢸⣿⠀
      ...
      dashboard.section.header.val = vim.split(logo, '\n')
        ...
        -- stylua: ignore
        -- Icons can be found at: https://www.nerdfonts.com/cheat-sheet
        dashboard.section.buttons.val = {
          dashboard.button('r', '󱈗 Recent', '<cmd> Telescope oldfiles <cr>'),
          dashboard.button('f', '󰮗 Find', [[<cmd> Telescope find_files <cr>]]),
          dashboard.button('g', '󰺯 Grep', [[<cmd> Telescope live_grep <cr>]]),
          dashboard.button('i', ' Init', ':e $MYVIMRC<CR>'),
          dashboard.button('d', '󰿁 Dash', ':e ~/.config/nvim/lua/custom/plugins/alpha.lua<CR>'),
